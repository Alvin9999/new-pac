...
点击图中的系统名字，会弹出具体系统版本，WireGuard VPN搭建脚本只支持CentOS7
...
![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/wire/3.png)

输入数字1进行CentOS7系统的内核升级，升级完成后重启服务器。

![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/wire/2.png)

安装到这个界面后需要重启下服务器。如果提示重启服务器y/n？ 输入y 。如果跳过了这条提示，输入reboot也能重启服务器。

![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/wire/4.png)
...
![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/wire/5.png)

3、然后输入一个用户名，不要和之前的重复

![](https://cdn.jsdelivr.net/gh/Alvin9999/pac2/wire/6.png)
